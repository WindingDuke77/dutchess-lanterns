# Dutchess Lanterns — Forge 1.12.2

The original Minecraft 1.12.2 Forge version of Dutchess Lanterns (mod id `lantern`).
See the [root README](../README.md) for the version table and [PORTING.md](../PORTING.md)
for how this project relates to the other versions.
...
Jar lands in `build/libs/lantern-forge-1.12.2-<version>.jar`. `deploy.bat` copies the newest jar into the Tekxit instance
